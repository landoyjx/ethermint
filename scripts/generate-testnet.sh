...
halled collect-gentxs --home testnet/node1
halled collect-gentxs --home testnet/node2
...
# 10. start each node, halled start --home node* --rpc.unsafe --log_level "main:info,state:info,mempool:info"
echo -e "\n------Enjoy it!------"
